...
//   Box<DownloadedSong> get downloadedSongsBox => Hive.box<DownloadedSong>('downloaded_songs');
...
//             _downloadProgress[song.songId]?.add(progress * 0.7); // 70% for audio
//           }
//         },
//       );
...
//           if (total != -1) {
//             final progress = received / total;
//             _downloadProgress[song.songId]?.add(0.7 + (progress * 0.2)); // 20% for image
//           }
//         },
//       );
...
//               if (total != -1) {
//                 final progress = received / total;
//                 _downloadProgress[song.songId]?.add(0.9 + (progress * 0.1)); // 10% for lyrics
//               }
//             },
//           );
//           lrcLocalPath = lrcPath;
//         } catch (e) {
//           debugPrint('Failed to download lyrics: $e');
//         }
//       }
